                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ url('updatepass') }}" method="POST" id="changepasswordform">
                                @csrf
                                @method('PUT')

                                <input type="hidden" name="id" value="{{ Session::get('AdminLogginId')['id'] }}">
                                <input type="hidden" id="password" value="{{ Session::get('AdminLogginId')['password'] }}">

            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="about-thumb">
                        <img src="./assets/images/about01.png" alt="about">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9 offset-lg-3 bg-two">
                    <div class="philosophy-content">
                        ...
                        <ul class="phisophy-list">
                            <li>
                                <div class="thumb">
                                    <img src="./assets/images/icon1.png" alt="philosophy">
                                </div>
                                <h5 class="title">Honesty & Fairness </h5>
                            </li>
                            <li>
                                <div class="thumb">
                                    <img src="./assets/images/icon2.png" alt="philosophy">
                                </div>
                                <h5 class="title">Clarity & Transparency</h5>
                            </li>
                            <li>
                                <div class="thumb">
                                    <img src="./assets/images/icon3.png" alt="philosophy">
                                </div>
                    ...
                    <div class="about-counter">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="./assets/images/about-counter01.png" alt="about">
                            </div>
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="./assets/images/about-counter02.png" alt="about">
                            </div>
                            <div class="counter-content">
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="./assets/images/about-counter03.png" alt="about">
                            </div>
                            <div class="counter-content">
                        ...
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="./assets/images/about-counter04.png" alt="about">
                            </div>
                            <div class="counter-content">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="tour-content">
                        ...
                        <ul class="list-tour">
                            <li>
                                <div class="thumb">
                                    <img src="./assets/images/icon01.png" alt="tour">
                                </div>
                                <div class="content">
                            ...
                            <li>
                                <div class="thumb">
                                    <img src="./assets/images/icon02.png" alt="tour">
                                </div>
                                <div class="content">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="tour-thumb">
                        <img src="./assets/images/tour.png" alt="tour">
                    </div>
                </div>
            </div>
        </div>
